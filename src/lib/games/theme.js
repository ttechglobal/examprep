// src/lib/games/theme.js
// (moved from src/lib/gameRegistry.js's sibling src/lib/gameTheme.js as part
//  of the games/ folder restructure — content unchanged, only the path and
//  this header comment changed. Update any import from '@/lib/gameTheme' to
//  '@/lib/games/theme'.)
// ─────────────────────────────────────────────────────────────────────────────
...
// doesn't specify its own bucket colour.
