// src/lib/games/registry.js
// (moved from src/lib/gameRegistry.js as part of the games/ folder
//  restructure — content unchanged, only the path and this header comment
//  changed. Update any import from '@/lib/gameRegistry' to
//  '@/lib/games/registry'.)
// ─────────────────────────────────────────────────────────────────────────────
...
// subject name in SUBJECT_THEME (src/lib/subjectTheme.js) AND your
// curriculum's `subjects` table — this is what lets world theming and
// mastery linking both resolve from one string.
