'use client'
// src/components/games/ConceptConnector.jsx
// REDESIGNED — same fix pattern: all colour via inline style from gameTheme.js,
// no Tailwind dynamic dark: classes. Match It theme (violet) used throughout.
...
export default function ConceptConnector({ game, onComplete }) {
  const isDark = useIsDark()
  const theme  = getGameTypeTheme('connector')
  ...
  // Result theme for wrong/correct chip states
